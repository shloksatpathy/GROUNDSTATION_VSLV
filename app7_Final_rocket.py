...
class Groundstation(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        grid.addWidget(self.plot_vspeed, 6, 2)  # placed at row 6, col 2
    ...
    def tick(self):
        ...
        for line in raw_lines:
            ...
            # --- Vertical speed calculation & plot ---
            try:
                vs_x = []
                vs_y = []
                if times_w:
                ...
                if vs_x and vs_y:
                    ...
                    try:
                        ymin, ymax = self._nice_range(vs_y, min_pad=0.2, min_span=0.5)
                        self.plot_vspeed.setXRange(max(t_min, vs_x[0]), t_now)
                        self.plot_vspeed.setYRange(ymin, ymax)
                    except Exception:
                        pass
                else:
