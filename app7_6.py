...
class Groundstation(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # top-left status labels: time, packets, state
    ...
    def tick(self):
        ...
        # show local uptime in label (you previously asked for device TIME_SINCE_S there instead; tell me if you want that change)
