...
class Groundstation(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # plots: now separated into individual time-series
        ...
        # place altitude/pressure/temp at top row (spans columns 0-2) and map at col 3
        ...
        # keep pressure vs altitude and temp vs altitude lower-left (older widgets) - move them below RPY
        ...
        self.plot_pres.setLabel('bottom', 'Time (s)')
        self.plot_temp.setLabel('bottom', 'Time (s)')
        self.plot_roll.setLabel('bottom', 'Time (s)')
        self.plot_pitch.setLabel('bottom', 'Time (s)')
        self.plot_yaw.setLabel('bottom', 'Time (s)')
